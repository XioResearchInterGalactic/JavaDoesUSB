...
[INFO] Building epaper-display 0.7.2-merlyn-1
[INFO]   from pom.xml
[INFO] --------------------------------[ jar ]---------------------------------
[INFO] 
...
$ $JAVA_HOME/bin/java --enable-preview --enable-native-access=ALL-UNNAMED -cp target/classes:/Users/me/.m2/repository/net/codecrete/usb/java-does-usb/0.7.2-merlyn-1/java-does-usb-0.7.2-merlyn-1.jar net.codecrete.usb.examples.EPaperDisplay
Display size: 1200 x 825
```
